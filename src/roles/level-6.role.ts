...
export default defineRole({
  ...
  objectPermissions: [
    ...[OBJECT_IDS.project, OBJECT_IDS.task, OBJECT_IDS.helpRequest, OBJECT_IDS.automation, OBJECT_IDS.interaction, OBJECT_IDS.taskEvent].map((objectUniversalIdentifier) => ({ objectUniversalIdentifier, canReadObjectRecords: true, canUpdateObjectRecords: true, canSoftDeleteObjectRecords: false, canDestroyObjectRecords: false })),
