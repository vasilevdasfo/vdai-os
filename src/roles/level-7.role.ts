...
export default defineRole({
  ...
  objectPermissions: [
    ...[OBJECT_IDS.workspace, OBJECT_IDS.project, OBJECT_IDS.task, OBJECT_IDS.automation, OBJECT_IDS.interaction, OBJECT_IDS.taskEvent, OBJECT_IDS.taskComment].map((objectUniversalIdentifier) => ({ objectUniversalIdentifier, canReadObjectRecords: true, canUpdateObjectRecords: false, canSoftDeleteObjectRecords: false, canDestroyObjectRecords: false })),
