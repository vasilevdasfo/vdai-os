...
export default defineRole({
  ...
  objectPermissions: [
    ...[OBJECT_IDS.workspace, OBJECT_IDS.project, OBJECT_IDS.task, OBJECT_IDS.helpRequest, OBJECT_IDS.automation].map((objectUniversalIdentifier) => ({ objectUniversalIdentifier, canReadObjectRecords: true, canUpdateObjectRecords: false, canSoftDeleteObjectRecords: false, canDestroyObjectRecords: false })),
